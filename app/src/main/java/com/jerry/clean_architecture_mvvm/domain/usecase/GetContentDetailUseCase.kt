...
open class GetContentDetailUseCase @Inject constructor(private val contentRepository: ContentRepository) {

    operator fun invoke(id: Int): Flow<MyResult<ContentDetailResponse>> = flow {
        try {
